...
export default function Home() {
  return (
    <div className="z-10 flex-1 p-5 bg-white rounded-lg shadow-lg md:shadow-none">
      <div>
        <div className="hidden md:block rounded-lg shadow-lg md:shadow-none z-10 flex-1 p-5 bg-white">
        ...
        <div className="md:hidden w-80 absolute shadow-lg z-10 flex-1 p-0 top-40 md:shadow-none bg-white">
